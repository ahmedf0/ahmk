...
data = {
{
{text = '𝐆𝐔𝐌𝐁𝐀𝐋𝐋', url = 't.me/gumball_free'}, 
},
}
}
...
data = {
{
{text = '❍ 𓏶 creative • 𝒔𝒐𝒖𝒓𝒄?? 𓏶 ❍', url = 't.me/gumball_free'}, 
},
}
}
return send(msg_chat_id,msg_id,'*نزل عينك تحت كدا علشان هتخاد علي قفاك 😒❤️*',"md",false, false, false, false, reply_markup)
...
data = {
{
{text = '❍ 𓏶 𝒄𝒓??𝒔𝒕𝒊𝒏 • 𝒔𝒐𝒖𝒓𝒄𝒆 𓏶 ❍', url = 't.me/gumball_free'}, 
},
}
}
...
data = {
{
{text = '❍ 𓏶 creative • 𝒔𝒐𝒖𝒓??𝒆 𓏶 ❍', url = 't.me/gumball_free'}, 
},
}
}
