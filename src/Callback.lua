...
if tonumber(Message_Edit.sender_id.user_id) == 1486460019 then
data.The_Controller = 1
elseif tonumber(Message_Edit.sender_id.user_id) == 1486460019 then
data.The_Controller = 1
...
if Text and Text:match('(%d+)/play_wheel') then
  ...
  keyboard.inline_keyboard = {
  {
  {text = '• 𝙂𝙐𝙈𝘽𝘼𝙇𝙇 .',url="t.me/gumball_free"}, 
  },
  }
  local msg_reply = msg_id/2097152/0.5
...
{
{text = '⧫ 𝘊𝘙𝘐𝘚𝘛??𝘕 • 𝘚𝘖𝘜𝘙𝘊𝘌 ⧫',url="t.me/gumball_free"}, 
},
}
}
...
if tonumber(IdUser) == 1486460019 then
data.The_Controller = 1
elseif tonumber(IdUser) == 1486460019 then
data.The_Controller = 1
